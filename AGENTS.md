...
Pasangan ini pernah menyimpang 21 baris tanpa ada yang menyadarinya, dan `shared-files.yml` hanya jalan kalau di-dispatch. Periksa sendiri: `diff <(tail -n +5 CLAUDE.md) <(tail -n +7 AGENTS.md)`.
