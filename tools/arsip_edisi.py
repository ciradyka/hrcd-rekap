...
def main():
    ...
    (keluar / "BACA-DULU.txt").write_text(
        ...
        "lembar-jawaban/  foto slip penilaian, folder per pos lalu per lomba:\n"
        "                   Pos 3/Kim Lihat/0003_Pos3_Kim-Lihat.jpg\n"
        "                 Nomor dada di depan supaya urut. Pos dan lomba ikut\n"
        "                 di nama berkas walau foldernya sudah menyebutkan,\n"
        "                 supaya satu gambar yang dipindah keluar foldernya\n"
        "                 masih menyebut asalnya. Akhiran -2, -3 berarti foto\n"
        "                 ulangan untuk regu dan lomba yang sama. Tiap folder\n"
        "                 punya _daftar.csv yang memetakan nomor dada ke nama\n"
        "                 regu dan sekolahnya.\n\n"
