...

    {
      ...
      isi: [
        ...
        },
        {
          jenis: "poin",
          butir: [
            "Mengurus izin prinsip sekolah, izin keramaian Polsek, dan surat ke Koramil serta camat.",
            "Menaiki tangga rekomendasi kegiatan satu per satu: Kwarran, Kwarcab, Kwarda Jawa Barat, lalu Kwarda Jawa Tengah dan DI Yogyakarta, dan terakhir Kwarnas. Tiap anak tangga menunggu surat di bawahnya benar-benar TERBIT.",
            "Menaiki tangga Kemenag secara terpisah, Kantor Kabupaten lalu Kanwil provinsi, karena MTs dan MA tidak dijangkau edaran Dinas Pendidikan.",
        ...
        },
        {
          ...
          kepala: ["Kapan", "Yang dikerjakan"],
          baris: [
            ["Sprint 2 sampai 5", "Izin prinsip, rekomendasi Kwarran dan Kwarcab, Kemenag Kabupaten, proposal, juklak dan juknis."],
            ["Sprint 6 sampai 8", "Kwarda Jabar dan Kanwil Kemenag, lalu Kwarda Jateng dan DIY, ditutup Kwarnas."],
...
export const SPRINT = [
  {
    ...
    tugas: [
      ...
      { kode: "s1-arsip", seksi: "Sekretariat", layar: "#/live-score",
        teks: "Pastikan arsip edisi lalu SUDAH keluar sebelum menyentuh apa pun: jalankan Actions -> Arsipkan edisi, unduh dua berkasnya, dan simpan yang berisi foto ke Drive ambalan. Cetakan kertas dari Live Score dan Kejuaraan tetap dibuat, tapi kertas tidak bisa dicari maupun dijumlah." },
...

  {
    ...
    tugas: [
      ...
      { kode: "s5-kemenag-kab", seksi: "Sekretaris", layar: null,
        teks: "Ajukan surat ke Kantor Kemenag Kabupaten supaya MTs dan MA se-kabupaten boleh ikut. Mereka tidak di bawah Dinas Pendidikan, jadi edaran lewat jalur sekolah negeri tidak pernah sampai ke sana." },
...

  {
    ...
    tugas: [
      ...
      { kode: "s6-kwarda-jabar", seksi: "Sekretaris", layar: null,
        teks: "Begitu rekomendasi Kwarcab TERBIT, email permohonan rekomendasi ke Kwartir Daerah Jawa Barat beserta seluruh lampirannya. Panitia yang mengirim sendiri, bukan menunggu Kwarcab meneruskan." },
      { kode: "s6-kanwil-kemenag", seksi: "Sekretaris", layar: null,
        teks: "Susulkan surat ke Kanwil Kemenag Jawa Barat, satu tingkat di atas Kantor Kemenag Kabupaten. Jalur Kemenag berjenjang persis seperti kwartir, karena MTs dan MA memang di bawahnya." },
...

  {
    ...
    tugas: [
      ...
      { kode: "s7-kwarda-luar", seksi: "Sekretaris", layar: null,
        teks: "Surati Kwartir Daerah Jawa Tengah dan Kwartir Daerah DI Yogyakarta, masing-masing berkas sendiri. Peserta dari sana butuh rekomendasi dari Kwarda MEREKA, bukan dari Kwarda kita — itu sebabnya dua surat ini tidak bisa diwakilkan satu pun." },
...

  {
    ...
    tugas: [
      ...
      { kode: "s8-kwarnas", seksi: "Sekretaris", layar: null,
        teks: "Kumpulkan jawaban ketiga Kwarda — Jabar, Jateng, DIY — lalu email ke Kwartir Nasional. Kwarnas menerima HASIL tangga di bawahnya; permohonan yang belum lewat satu Kwarda pun akan dikembalikan ke bawah." },
...

  {
    ...
    tugas: [
      ...
      { kode: "s13-arsip", seksi: "Sekretariat", layar: "#/kejuaraan",
        teks: "Keluarkan arsip lewat Actions -> Arsipkan edisi: satu berkas angka dan satu berkas foto lembar jawaban, sudah tersusun per lomba supaya bisa langsung diseret ke Drive. Lalu cetak Rekap Nilai Semua, Daftar Kloter final, dan Daftar Juara, simpan bersama notulen dan berkas izin." },
      ...
      { kode: "s13-serah-terima", seksi: "Penanggung Jawab Umum", layar: null,
        teks: "Serahkan akses akun organisasi, arsip, dan buku ini ke kepengurusan berikutnya, lalu mulai lagi dari Sprint 1. Sebutkan di mana arsipnya berada — folder Drive-nya, bukan cuma 'ada di Supabase'." },
    ],
    jangan: "Jangan membersihkan data acara sebelum arsipnya KELUAR dan LPJ selesai. Bukan cuma tercetak: yang di kertas tidak bisa dicari, dijumlah, atau dibandingkan dengan edisi lain. Sekali dibersihkan, klasemen, nilai mentah, dan daftar juara tidak bisa dikembalikan dari mana pun.",
  },
];
...
const BAB_SPRINT = {
  ...
  ringkas: "Tiga belas sprint dari Serah Terima Jabatan sampai hari-H, "
    + "ditutup satu sprint evaluasi. Satu sprint dua minggu, jadi tiap bulan "
    + "memuat dua: Minggu 1 dan Minggu 2. Tiap tugas bisa dicentang, dan "
